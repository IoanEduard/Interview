<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{ invalid: !firstName.isValid }">
      ...
      <p v-if="!firstName.isValid">name must be not empty</p>
    </div>
    ...
    <div class="form-control" :class="{ invalid: !rate.isValid }">
      ...
      <p v-if="!rate.isValid">Rate name must be not empty</p>
    </div>
    <div class="form-control">
      ...
      <div class="form-control" :class="{ invalid: !areas.isValid }">
        <input type="checkbox" id="career" value="areas" v-model="areas.val" @blur="clearValidity('areas')"/>
        <label for="career">Career Advisory</label>
        <p v-if="!areas.isValid">Caerre name must be not empty</p>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      if (this.rate.val && this.rate.val === null && this.rate.val < 0) {
